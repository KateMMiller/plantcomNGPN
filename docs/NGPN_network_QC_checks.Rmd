...
year_range <- ifelse(params$all_years == TRUE, 2011:year_curr, year_curr)
...
```{r eval = taxa_miss_include, results = 'asis'}
cat("#### Missing Values {.tabset}", "\n\n")

check_null_print(kbl_taxa_miss_sci, 5, "Blank SciName")

check_null_print(kbl_taxa_miss_sym, 5, "Blank Symbol")

check_null_print(kbl_taxa_miss_tsn, 5, "Blank ITIS_TSN")

cat("\n\n")
```


```{r eval = taxa_incon_include, results = 'asis'}
cat("#### Inconsistent Naming {.tabset}", "\n\n")

check_null_print(kbl_taxa_dup_notbio, 5, "Not Biological")

check_null_print(kbl_taxa_dup_bio, 5, "Biological")
...
```{r eval = pint_miss_include, results = 'asis'}
cat("#### Missing Values {.tabset}", "\n\n")

check_null_print(kbl_num_ground, 5, "Num Ground Hits")

check_null_print(kbl_ht_check, 5, "Missing Heights")

cat("\n\n")
```

```{r eval = pint_dup_include, results = 'asis'}
cat("#### Duplicates {.tabset}", "\n\n")

check_null_print(kbl_dup_order, 5, "Duplicate Orders")
...
```{r eval = pint_range_include, results = 'asis'}
cat("#### Out of range {.tabset}", "\n\n")

check_null_print(kbl_ht_oor, 5, "Height over 2m")
