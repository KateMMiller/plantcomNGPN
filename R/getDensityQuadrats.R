...
#' "verbose" returns all columns in the DensityQuadrats database tables.
#'
#' @examples
#' \dontrun{
#'
...
getDensityQuadrats <- function(park = 'all', plot_name = "all", project = "Park", purpose = "NGPN_PCM",
  ...
  keep_cols <- c("MacroPlot_Name", "Unit_Name", "MacroPlot_Purpose", "ProjectUnit_Name",
                 ...
                 "Visited", "NumTran", "NumQuadTran", "QuadLen", "QuadWid", "Area",
                 "Index", "Transect", "Quadrat", "Status", "SizeCl", "AgeCl", "Count", #"Height",
                 "SubFrac", "Comment", "UV1", #"UV2", "UV3",
                 "UV1Desc", #"UV2Desc",
                 "SaComment",
