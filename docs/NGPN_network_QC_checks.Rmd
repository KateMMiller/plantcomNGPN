...
check_null_print(kbl_monstat_incon, 4, "Name Inconsistencies")

cat("\n\n")
```


```{r eval = taxa_include, results = 'asis'}
cat("### Taxa Table {.tabset}", "\n\n")

check_null_print(kbl_taxa_miss_sci, 4, "Blank SciName")

check_null_print(kbl_taxa_miss_sym, 4, "Blank Symbol")

check_null_print(kbl_taxa_miss_tsn, 4, "Blank ITIS_TSN")

check_null_print(kbl_taxa_miss_nb, 4, "Blank NotBio")

check_null_print(kbl_taxa_dup_notbio, 4, "Inconsistent NotBio")

check_null_print(kbl_taxa_dup_bio, 4, "Inconsistent Species")

cat("\n\n")
```


```{r eval = pint_include, results = 'asis'}
cat("### Point Intercept {.tabset}", "\n\n")

check_null_print(kbl_num_ground, 4, "Missing Ground")

check_null_print(kbl_ht_check, 4, "Missing Height")
...
check_null_print(kbl_stat_blank, 4, "Status Blanks")

check_null_print(kbl_nb_l_stat, 4, "NotBio Live")
...
```{r eval = densb_include, results = 'asis'}
...
```{r eval = targ_include, results = 'asis'}
cat("### Target Species Detections {.tabset}", "\n\n")

check_null_print(kbl_inv_targ, 4, "Invasive Species")

check_null_print(kbl_oth_targ, 4, "Other Species")
