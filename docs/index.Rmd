...
RTools is needed to install R packages from GitHub via devtools, and it only works with R versions 4.4.x. While R 4.5 is available on Software Center, the matching RTools45 isn't available as of 8/20/25. Until that changes, link RStudio to the latest version of R 4.4 (I'm currently using R 4.4.3).
