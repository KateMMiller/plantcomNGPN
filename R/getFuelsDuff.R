...
#' \item{"NGPN_PCM":} {Default. NGPN Plant Community Monitoring Plots with c("_PCM_", "_FPCM_", "_LPCM_", and, "_RCM_") in their name, and all of the purposes deduffd below.}
...
getFuelsDuff <- function(park = 'all', plot_name = "all", project = "Park", purpose = "NGPN_PCM",
  ...
  keep_cols <- c("MacroPlot_Name", "Unit_Name", "MacroPlot_Purpose", "ProjectUnit_Name",
                 "UTM_X", "UTM_Y", "UTMzone",
                 "Elevation", "Aspect", "Azimuth", "SlopeHill", "SlopeTransect",
                 "SampleEvent_Date", "year", "month", "doy", "DefaultMonitoringStatus",
                 "MonitoringStatus_Base",
                 "Visited", "NumTran",
                 "Index", "Transect", "SampLoc", "OffSet", "LittDep", "DuffDep", "FuelbedDep",
                 "DLFuConSt", "Comment", "UV1Desc", #"UV2Desc",
                 "SaComment", "MacroPlot_GUID", "SampleEvent_GUID", "RegistrationUnit_GUID")
