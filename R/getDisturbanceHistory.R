...
#' "verbose" returns all columns in the DisturbanceHistory database tables.
#'
#' @examples
#' \dontrun{
#'
...
getDisturbanceHistory <- function(park = 'all', plot_name = "all", project = "Park", purpose = "NGPN_PCM",
  ...
  keep_cols <- c("MacroPlot_Name", "Unit_Name", "MacroPlot_Purpose", "ProjectUnit_Name",
                 ...
                 "Visited", "Index", "ChAgent", "ChgDesc", "Comment", "UV1", "UV2", "UV3",
