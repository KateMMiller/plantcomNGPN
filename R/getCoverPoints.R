...
#'
#' @description This function filters and joins FFI cover point data by park,
#' plot name, purpose, project, sample year, and other parameters.
#'
...
getCoverPoints <- function(park = 'all', plot_name = "all", project = "Park",
